...
{
  protected static azure.vlab.crackle.Module module;
  ...
  public static void main(String[] args)
  {
    try
    {
      ...
      for (int i = 0; i < args.length; i++)
      {
        ...
        azure.vlab.crackle.Module module = run(args[i], outLog);
      }
    }
    catch (Exception e)
    {
   ...
   */
  public static azure.vlab.crackle.Module run(String inFile, PrintWriter outLog)
  {
    try
    {
  ...
  public static azure.vlab.crackle.Module run(String inFile, Reader reader, PrintWriter outLog)
  {
    idlLog = outLog;
    try
    {
  ...
  {
    int procNumber = azure.vlab.crackle.Module.hashCode(prototype.name);
    if (procNumber < 0)
      procNumber *= -1;
    Integer newNo;
    incProcNumber:
