...
//        writeln(2, "return ''");
//        writeln("dbapi_util.returning = Lite3Returning");
//        writeln();
...
//        writeln(2, "_command = f'select last_insert_rowid()+1 from {self.table}'");
