...
public class TJCStructs //extends Writer
{
  ...
  public static void generateSnips(Table table, String output, PrintWriter outLog, boolean checkBindO) throws Exception
  {
  ...
  public static void generateStdOutputRec(Table table)
  {
  ...
  public static void generateUserOutputRecs(Table table)
  {
    for (int i = 0; i < table.procs.size(); i++)
    {
      Proc proc = table.procs.elementAt(i);
