...
DBApiShell::DBApiShell(tLogFile* aLogFile, const char* name, const char* configfile, const char* prefix)
{
    logFile = aLogFile;
...
void putty3Runner(string methodStr, string inputStr, string &outputStr)
{
    ...
    try
    {
        string moduleName = DBApiShell::modulePrefix;
        moduleName += "_JSON";
